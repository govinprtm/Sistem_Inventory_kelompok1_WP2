    ...
    */
    public function fetchProductData()
    {
        ...
        foreach ($data as $key => $value) {
            ...
            $img = '<img src="' . base_url($value['image']) . '" alt="' . $value['name'] . '" width="80" />';
            ...
            $qty_status = '';
            if ($value['qty'] <= 10) {
                $qty_status = '<span class="badge badge-warning font-weight-normal">Stok Menipis</span>';
            } else if ($value['qty'] <= 0) {
                $qty_status = '<span class="badge badge-danger font-weight-normal">Habis</span>';
            }
