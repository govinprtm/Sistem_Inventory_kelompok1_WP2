        ...
        <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('reports/') ?>" method="POST">
            <div class="form-group">
              <label for="date" class="mr-2">Tahun</label>&nbsp;
              <select class="form-control mr-2" name="select_year" id="select_year">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">TOTAL PENDAPATAN TAHUN <?= $selected_year; ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="card-body">
              <div class="chart">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Total Penjualan Dibayar - Data Laporan</h3>
            </div>
            <!-- /.box-header -->
            <div class="card-body">
