                        ...
                        <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select_group store <?php if (form_error('store_id')) { ?> <?= "is-invalid"; ?> <?php }; ?>" id="store_id" name="store_id" style="width:100%;">
                                                ...
                                                <?php foreach ($suppliers as $r => $v) : ?>
                                                    <option value="<?php echo $v['id'] ?>" <?php if ($orders_data['orders']['store_id'] == $v['id']) { ?> <?php echo "selected='selected'"; ?> <?php  } ?>><?php echo $v['name'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="order_date" name="order_date" placeholder="Tanggal Transaksi" autocomplete="off" value="<?= date('Y-m-d', strtotime($orders_data['orders']['order_date'])); ?>" />
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered" id="product_info_table">
                                    ...
                                    <tbody>
                                        <?php if (isset($orders_data['orders_item'])) : ?>
                                            <?php $x = 1; ?>
                                            <?php foreach ($orders_data['orders_item'] as $key => $val) : ?>
                                                <?php //print_r($v); 
                                                ?>
                                ...
                                <div class="row">
                                    <div class="col-md-5 ml-auto mt-3">
                                        ...
                                        <input type="hidden" id="gross_amount" name="gross_amount" disabled autocomplete="off">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <input type="text" class="form-control" id="net_amount" name="net_amount" disabled value="<?php echo $orders_data['orders']['net_amount'] ?>" autocomplete="off">
                                                <input type="hidden" id="net_amount_value" name="net_amount_value" value="<?php echo $orders_data['orders']['net_amount'] ?>" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
