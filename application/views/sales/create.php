                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="date_time" name="date_time" placeholder="Tanggal Transaksi" autocomplete="off" value="<?= date('Y-m-d'); ?>" />
                    </div>
                  </div>
                  <div class="col">
                    <div class="form-group">
                      <label>Tanggal Jatuh Tempo:</label>
                      <input type="date" class="form-control" id="due_date" name="due_date" placeholder="Tanggal Jatuh Tempo" autocomplete="off" value="<?= date('Y-m-d', strtotime("+1 month")); ?>" />
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control <?php if (form_error('customer_name')) { ?> <?= "is-invalid"; ?> <?php }; ?>" id="customer_name" name="customer_name" placeholder="Nama Pelanggan" autocomplete="off" />
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Alamat Pelanggan" autocomplete="off">
                    </div>
                  </div>
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Telepon Pelanggan" autocomplete="off">
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#addSalesNav .nav-link").addClass('active');
